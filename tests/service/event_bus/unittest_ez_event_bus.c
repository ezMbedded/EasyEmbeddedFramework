...
int Listener1_Callback(uint32_t event_code, void *param1, void *param2);
int Listener2_Callback(uint32_t event_code, void *param1, void *param2);
...
TEST_SETUP(ez_event_bus)
{
    ...
    success = (ezSUCCESS == ezEventBus_CreateBus(&test_subject));
...
TEST(ez_event_bus, NotifyEvent1)
{
    ...
    ezEventBus_SendEvent(&test_subject, NOTIFY_CODE_1, NULL, NULL);
